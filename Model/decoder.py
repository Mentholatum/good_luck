...
class Attention(nn.Module):
    ...
    def __init__(self, encoder_dim, decoder_dim, attention_dim):
        """
        :param encoder_dim: feature size of encoded images 编码图像的特征维度大小
        :param decoder_dim: size of decoder's RNN 解码器 RNN 的大小
        :param attention_dim: size of the attention network 注意力网络的大小
        """
